...
def get_args_parser():
    parser = argparse.ArgumentParser('PyTorch CIFAR Dataset Training', add_help=False)
    parser.add_argument('--batch-size', default=80, type=int)
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='densenet100bc', type=str, metavar='MODEL',
...
def main(args):
    ...
    ckpt.load("C:/Users/Kelun/Desktop/model/model_best.pth")
    image_path = "C:/Users/Kelun/Desktop/dataset/val/character_0/0.jpg"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('PyTorch CIFAR Dataset Training', parents=[get_args_parser()])
