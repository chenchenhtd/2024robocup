...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default=os.path.join(os.path.expanduser("~"), 'C:\\Users\\Kelun\\Desktop\\dataset'), type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default='C:/Users/Kelun/Desktop/model/',
...
def main(args):
    ...
    linear_scaled_lr = args.lr * args.batch_size / 256.0
    args.lr = linear_scaled_lr
    print(f"Scaled learning rate (batch size: {args.batch_size}): {linear_scaled_lr}")
    ...
    print(f"Start training, current max acc is {max_accuracy:.2f}")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_stats = evaluate(data_loader_val, model, device,1,False,False)
        print(f"Accuracy of the network on the {len(dataset_val)} test images: {test_stats['acc1']:.2f}%")
