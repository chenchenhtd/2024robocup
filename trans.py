...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='C:/Users/Kelun/Desktop/imagenet/save',
    ...
    parser.add_argument('--initial_checkpoint', type=str, default='models/checkpoint.pth',help='path to the pretrained model')
